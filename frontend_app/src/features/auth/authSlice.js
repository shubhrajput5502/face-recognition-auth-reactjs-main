...
export const authSlice = createSlice({
    ...
    reducers: {
        ...
        setRegisterUserType(state, action) {
            state.request.register.userType = action.payload;
        },
...
export const { setActiveTab, setActiveSource, setCameraStatus, setIsFlashing, setScreenshot, setRegisterName, setRegisterEmail, setRegisterPassword, setRegisterRepeatPassword,setRegisterUserType, setLoginEmail, setLoginPassword, setUser, resetAuthState, setAuthError, setURL} = authSlice.actions
